(() => {
  ...
  // extensions/checkout-billing-validation/src/Checkout.jsx
  ...
  function Extension() {
    ...
    useBuyerJourneyIntercept(({ canBlockProgress }) => {
      if (canBlockProgress) {
        ...
        if (String(billingAddress.countryCode) == "US" || String(billingAddress.countryCode) == "CA") {
    ...
    return /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(View2, { visibility: showError == false ? "hidden" : "", children: /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(Banner2, { title: "Please update the Billing address to continue.", status: "critical", children: /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(TextBlock2, { children: errorMessage }) }) });
  }
