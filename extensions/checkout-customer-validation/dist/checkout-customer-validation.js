...
${errorInfo.componentStack}`);
  ...
  // extensions/checkout-customer-validation/src/Checkout.jsx
  ...
  function Extension() {
    ...
    useBuyerJourneyIntercept(({ canBlockProgress }) => {
      if (canBlockProgress) {
        let errors = [];
        if (String(shippingAddress.countryCode) == "US" || String(shippingAddress.countryCode) == "CA") {
    ...
    return /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(View2, { visibility: "false" });
  }
