(() => {
  ...
  // extensions/checkout-banned-items/src/Checkout.jsx
...
${errorInfo.componentStack}`);
  ...
  // extensions/checkout-banned-items/src/modules/CountryHelper.js
  var codes = [{
    code: "AD",
    name: "ANDORRA"
  }, {
  ...
  function Extension() {
    const [visibility, setVisibility] = import_react14.default.useState(false);
    const [loading, setLoading] = import_react14.default.useState(false);
    const [countries, setCountries] = import_react14.default.useState([]);
    const [isBanned, setIsBanned] = import_react14.default.useState(false);
    ...
    useBuyerJourneyIntercept(({ canBlockProgress }) => {
      if (canBlockProgress) {
        if (shippingAddress.countryCode) {
          let isBanned2 = countries.find((country) => {
            return String(country == null ? void 0 : country.code).toLocaleLowerCase() === String(shippingAddress.countryCode).toLocaleLowerCase();
          });
          if (isBanned2) {
            setVisibility(true);
            setIsBanned(true);
    ...
    return /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)(View2, { visibility: visibility ? "" : "hidden", display: "block", padding: ["none", "none"], children: [
      loading && /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(SkeletonText2, {}),
      !loading && isBanned && /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(Text2, { appearance: "critical", emphasis: "bold", size: "small", children: "This item is not permitted in your country." })
    ] });
  }
})();
