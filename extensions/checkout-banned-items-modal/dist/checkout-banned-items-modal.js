(() => {
  ...
  // extensions/checkout-banned-items-modal/src/Checkout.jsx
...
${errorInfo.componentStack}`);
  ...
  function useBuyerJourneyIntercept(interceptor) {
    ...
    const interceptorRef = (0, import_react19.useRef)(interceptor);
  ...
  // extensions/checkout-banned-items-modal/src/modules/ArrayHelper.js
  ...
  // extensions/checkout-banned-items-modal/src/modules/CountryHelper.js
  var codes = [{
    code: "AD",
    name: "ANDORRA"
  }, {
  ...
  function GetCountryByCode(code) {
    let result = codes.find((item) => {
      return String(item.code).toLowerCase() === String(code).toLowerCase();
    });
    if (result) {
      return Object.assign({}, result, { name: CapitalizeEachWord(result.name) });
    }
    return null;
  }
  ...
  function Extension() {
    const [removeLoading, setRemoveLoading] = import_react20.default.useState(false);
    const [bannedItems, setBanneditems] = import_react20.default.useState([]);
    const [invalidItems, setInvalidItems] = import_react20.default.useState([]);
    const [products, setProducts] = import_react20.default.useState([]);
    const [country, setCountry] = import_react20.default.useState({ code: "", name: "" });
    const items = useCartLines();
    const shippingAddress = useShippingAddress();
    const applyCartLinesChange = useApplyCartLinesChange();
    const { query } = useApi();
    const getBannedCountryCodes = (items2) => {
    ...
    const getProductWithCountryCode = (item) => {
      return new Promise((resolve, reject) => {
        ...
        return query(
          `query {
          product (id: "${(_b = (_a = item == null ? void 0 : item.merchandise) == null ? void 0 : _a.product) == null ? void 0 : _b.id}") {
            tags
          }
        }`
        ).then((response) => {
          let codes2 = getBannedCountryCodes(response.data.product.tags);
          return resolve({ item, codes: codes2 });
        }).catch((err) => {
          return reject(err);
        });
      });
      ...
      if (canBlockProgress) {
        if (shippingAddress.countryCode) {
          let findInvalids = products.filter((product) => {
            let invalid = product.codes.some((country2) => {
              return !(country2 == null ? void 0 : country2.code);
            });
          ...
          setBanneditems(products.filter((product) => {
            return product.codes.find((country2) => {
              return String(country2 == null ? void 0 : country2.code).toLowerCase() === String(shippingAddress.countryCode).toLowerCase();
            });
          }));
    ...
    const RemoveItems = import_react20.default.useCallback(() => {
    ...
    return /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)(import_jsx_runtime4.Fragment, { children: [
      /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(View2, { visibility: bannedItems.length === 0 ? "hidden" : "", children: /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)(Banner2, { title: "Whoops, review your cart!", status: "critical", children: [
        /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)(TextBlock2, { children: [
          "Your cart contains items that cannot be shipped to ",
          country.name,
          ". Would you like us to remove these items so you can continue checkout?"
        ] }),
        /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(BlockSpacer2, {}),
        bannedItems.length && /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(List2, { children: bannedItems.map((line) => {
          var _a, _b, _c, _d;
          return /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(ListItem2, { children: (_d = (_c = line == null ? void 0 : line.item) == null ? void 0 : _c.merchandise) == null ? void 0 : _d.title }, (_b = (_a = line == null ? void 0 : line.item) == null ? void 0 : _a.merchandise) == null ? void 0 : _b.product.id);
        }) }),
        /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(BlockSpacer2, {}),
        !removeLoading ? /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(Button2, { appearance: "monochrome", kind: "secondary", onPress: RemoveItems, children: "Remove Items" }) : /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(Spinner2, {})
      ] }) }),
      /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(View2, { visibility: invalidItems.length === 0 ? "hidden" : "", children: /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)(Banner2, { title: "Whoops, review your cart!", status: "warning", children: [
        /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(TextBlock2, { children: "We regret to inform you that we are currently unable to proceed with shipping due to an issue with the following products:" }),
        /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(BlockSpacer2, {}),
        invalidItems.length && /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(List2, { children: invalidItems.map((line) => {
          var _a, _b, _c, _d;
          return /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(ListItem2, { children: (_d = (_c = line == null ? void 0 : line.item) == null ? void 0 : _c.merchandise) == null ? void 0 : _d.title }, (_b = (_a = line == null ? void 0 : line.item) == null ? void 0 : _a.merchandise) == null ? void 0 : _b.product.id);
        }) }),
        /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(BlockSpacer2, {}),
        /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)(Text2, { children: [
          ...
          /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(Text2, { emphasis: true, children: "info@.com" }),
          "."
        ] })
      ] }) })
    ] });
